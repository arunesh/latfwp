...
detials of which are not discussed in this document. The rest of the tokens will be available for the network. 
...
resources, reward an intial set of users for onboarding and fund developer communities, etc.
